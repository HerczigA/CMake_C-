...
First "project" to read from a file which is given as an argumentum to the program. 
The program try to read some string (or numbers) and remove '-' sign if there is somewhere.
